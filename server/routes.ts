...
import { insertProjectSchema, insertContributorSchema, insertSalesDataSchema, insertBookSchema, insertSeriesSchema, insertAuthorSchema, insertAuthorBiographySchema, insertContentRecommendationSchema, insertAiPromptTemplateSchema, insertKdpImportSchema, insertKdpImportDataSchema } from "../shared/schema.ts";
import { aiService } from "./services/aiService.ts";
import { parseKDPReport } from "./services/kdpParser.ts";
import { KdpImportProcessor } from "./services/kdpImportProcessor.ts";
import { KdpRoyaltiesEstimatorProcessor } from "./services/kdpRoyaltiesEstimatorProcessor.ts";
import { generateUniqueIsbnPlaceholder, ensureIsbnPlaceholder } from "./utils/isbnGenerator.ts";
import XLSX from 'xlsx';
import path from 'path';
import fs from 'fs';
import { seedDatabase, forceSeedDatabase } from "./seedDatabase.ts";
import { z } from "zod";
