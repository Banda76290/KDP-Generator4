...
- **Deployment Crash Fix**: Resolved framer-motion production crash (August 2025). Removed unused framer-motion dependency that was causing "TypeError: Cannot read properties of undefined (reading 'join')" during deployment. Server now starts correctly in production environment without animation library conflicts.
